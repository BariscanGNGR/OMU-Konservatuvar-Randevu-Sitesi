...
<html lang="tr">
  ...
  <body>
       ...
       $GLOBALS['yazdir'] .= '<label for="eposta" class="text-muted">E-posta</label>
       <input class="form-control mb-4" type="text" id="eposta" name="eposta" value="'.$row['e-posta'].'">

       <label for="ad" class="text-muted">Ad Soyad</label>
       <input class="form-control mb-4" type="text" id="ad" name="ad" value="'.$row['ad_soyad'].'">

       <label for="tel" class="text-muted">Telefon Numarası</label>
       <input class="form-control mb-5" type="text" id="tel" name="tel" value="'.$row['telefon_numara'].'">';

       if(isset($_POST['duzenle']))
       {
        verileriGuncelle($sql,$_POST['ad'],$_POST['eposta'],$_POST['tel'],$_SESSION['ogr_no']);
        header('location:hesap.php');
       }
        ...
        <div class="album py-5 bg-light mt-4">
		 <div class="container mt-3 mb-0 "style="" >
             ...
             <?php echo $GLOBALS['yazdir']; ?>
				...
				<input type="submit" class="btn btn-sm btn-primary btn-block mt3 mb-2" name="duzenle" value="Bilgileri Güncelle">
                <input type="submit" class="btn btn-sm btn-danger mt-3 mb-2" name="sifre" value="Şifre Değiştirmek için tıklayınız">
        <?php echo $GLOBALS['bilgi']; ?></div>
